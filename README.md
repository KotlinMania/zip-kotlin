# zip-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fzip--kotlin-blue.svg)](https://github.com/KotlinMania/zip-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/zip-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/zip-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/zip-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/zip-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`zip-rs/zip2`](https://github.com/zip-rs/zip2).

**Original Project:** This port is based on [`zip-rs/zip2`](https://github.com/zip-rs/zip2). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `zip-rs/zip2`

> The text below is reproduced and lightly edited from [`https://github.com/zip-rs/zip2`](https://github.com/zip-rs/zip2). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
Licensed under the [MIT License](https://github.com/zip-rs/zip2/blob/HEAD/LICENSE). Some files in the "tests/data" subdirectory of this repository are under other
...
This Kotlin port is distributed under the same MIT license as the upstream [`zip-rs/zip2`](https://github.com/zip-rs/zip2). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the zip2 authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`zip-rs/zip2`](https://github.com/zip-rs/zip2) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
