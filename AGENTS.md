...
This file is the quick-reference operating contract for zip-kotlin. The longer
...
zip-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`zip`](https://crates.io/crates/zip). Upstream Rust is the behavioral oracle while the
