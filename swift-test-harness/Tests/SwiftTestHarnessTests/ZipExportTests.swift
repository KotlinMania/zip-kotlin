...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Zip.swiftmodule/`
...
//      `import Zip` above would fail at compile time.
//
//   2. The static archive `libZip.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Zip" }` and
//      `flattenPackage = "io.github.kotlinmania.zip"` configuration in
...
final class ZipExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Zip swift module imported cleanly")
    }
}
